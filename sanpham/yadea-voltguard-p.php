...
<body>
    ...
    <div class="product-details">
      ...
      <div class="color-options">
        ...
        <div class="color-picker">
          ...
          <label for="gray" class="color-box" style="background-color: #AEAEA9;"></label>
        </div>
  ...
  *Giá bán xe đã bao gồm thuế VAT, chưa bao gồm thuế trước bạ và biển số
  ...
  <script>
    const images = [
      '../image/Anh-sp-chinh-1200x880-trang.png',// white
      '../image/Anh-sp-chinh-1200x880-den.png',                             // black
      '../image/Anh-sp-chinh-1200x880-xam.png',
    ];
...
<script>
  document.getElementById('checkoutForm').addEventListener('submit', function(event) {
    ...
    document.getElementById('product_price').value = 27990000;
    document.getElementById('product_name').value = 'YADEA Voltguard P';
  });
</script>
